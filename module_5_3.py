...
class House:                                       # класс "House".
    ...
    def __radd__(self, other): # метод сравнения __radd__(+), прибавляет числовое значение к предидущей
        # операции __add__
         return self.__add__(other) # возврат значения self.__add__

    def __iadd__(self, other): # метод сравнения __iadd__(+=), прибавляет числовое значение к предидущей
        # операции __radd__
        if isinstance(other, int): #
            self.number_of_floors += other # прибавляет числовое значение к предидущей операции __radd__
        return self #
