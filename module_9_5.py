...
for i in iter5:
    print(i, end=' ')
print() # так как стартовое значение больше стопового значения и шаг итерации не задан как отрицательный,
# то срабатывает исключение raise StopIteration() согласно условию